...
public:
	...
	{
		if (gCameraMain == NULL)
			gCameraMain = new Camera(D3DXVECTOR3(1000.0f, 1500.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
		else
			gCameraMain->init(D3DXVECTOR3(1000.0f, 1500.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
	}
