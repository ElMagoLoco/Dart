...
{
	//background
	mMenu = new Menu(L"Content/Textures/main_menu_back.png", 0.0f, 0.0f, 1024, 1024,
		1.0f, 1.0f);
	//button to go to windowed mode
	Button1024x768* b1024x768 = new Button1024x768(L"Content/Textures/button_1024x768.png",
		0.6f, 0.2f, 128, 64, 0.2f, 0.1f);
	...
	ButtonFullScreen* bFullScreen = new ButtonFullScreen(L"Content/Textures/button_full_screen.png",
		0.6f, 0.45f, 128, 64, 0.2f, 0.1f);
	mMenu->addButton(bFullScreen);
	//button to return to main menu
	ButtonGoBack* bGoBack = new ButtonGoBack(L"Content/Textures/button_go_back.png",
		0.6f, 0.7f, 128, 64, 0.2f, 0.1f);
...
void EventProcessLevel1::beginEvent()
{
	...
	meshGround->addTexture(L"Content/Textures/grass_h.dds", L"Content/Textures/grass_n.dds");
	gCurrentLevel->addGround(meshGround);
	//add obstacles
	Mesh* meshObstacle = new Mesh(L"Content/Models/box.x", D3DXVECTOR3(100.0f, 50.0f, 100.0f));
	meshObstacle->addTexture(L"Content/Textures/energy_h.dds", L"Content/Textures/energy_n.dds");
